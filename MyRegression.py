...
################################
    ...
    # draw curve looked like Receiver-Operating Characteristic curve
    if type == 'GD':
        plt.title('Linear Regression - Gradient Descent')
    elif type == 'matrix':
        plt.title('Linear Regression - Matrix')
    plt.xlabel('Allowable Error Range')
    plt.ylabel('Accuracy')
